  ...
  <div>
    <div class="search-bar">
      ...
      <Row :gutter="10" class="m-t-25">
        ...
        <i-col span="12">
          <div class="f-r">
            <i-button type="primary" ghost>{{$t('btnBar.btn_recheck')}}</i-button>
            <i-button type="primary" class="m-l-10" ghost>{{$t('btnBar.btn_hazard')}}</i-button>
    ...
    <Modal v-model="modalFg.modal_edit" width="422" footer-hide class-name="padding-50-modal" scrollable :title="modalFg.modal_title">
      <i-form :model="formItem" :label-width="50" label-position="left">
        <FormItem :label="$t('checked.num')">
          <i-input v-model="formItem.inputnum" :placeholder="$t('checked.tipnum')"></i-input>
        </FormItem>
        <FormItem :label="$t('checked.name')">
          <i-input v-model="formItem.inputname" :placeholder="$t('checked.tipname')"></i-input>
        </FormItem>
        <FormItem :label="$t('checked.age')">
          <i-button class="border-none f-s-18" size="small" @click="minusAge">{{$t('checked.minus')}}</i-button>
          <i-input v-model="formItem.inputage" class="w-113 t-c-input"></i-input>
          <i-button class="border-none f-s-18" size="small" @click="plusAge">{{$t('checked.plus')}}</i-button>
        </FormItem>
        <FormItem :label="$t('checked.sex')">
